    ...
    <div class="modal-dialog">
        <div class="modal-content-ticket">
            ...
            <div class="modal-body">
                ...
                <input type="date" name="date" value="" placeholder="Datum (0000-00-00)" id="mobile_date">
                <input type="text" name="animal_species" placeholder="Dier" id="mobile_animal_species">
                <input type="text" name="location" value="" placeholder="Stad/Dorp" id="mobile_location">
                <input class="btn btn-success full-width" data-dismiss="modal" type="submit" name="submit" value="Filteren" onclick="mobileFilterTickets()">
                <input class="btn btn-success" type="submit" name="resetfilter" value="Reset filter" onclick="resetFilter()">
